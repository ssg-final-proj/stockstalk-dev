...
class User(db.Model):
    ...
    last_seed_update = db.Column(db.DateTime)
...
class Portfolio(db.Model):
    ...
    stock_symbol = db.Column(db.String(50), ForeignKey(f"{current_config.PORTFOLIO_SCHEMA}.stocks.stock_symbol", ondelete="CASCADE"), nullable=False)
